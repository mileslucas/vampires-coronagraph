...
let thicknesses, trans, ts, mean_trans, mean_thick
    ...
    heatmap(thicknesses, λ, log10.(attenuation.(thicknesses', λ, Au)),
            c = :inferno,
            xlabel = "thickness",
            ylabel = "λ",
            title = "Gold (Au)",
...
let thicknesses, trans, ts, mean_trans, mean_thick
    ...
    heatmap(thicknesses, λ, log10.(trans_au .+ trans_cr),
            c = :inferno,
            xlabel = "thickness",
            ylabel = "λ",
...
let thicknesses, trans, ts, mean_trans, mean_thick
    thicknesses = range(0, 500, length = 101)u"nm"
    heatmap(thicknesses, λ, log10.(attenuation.(thicknesses', λ, Cr)),
            c = :viridis,
            xlabel = "thickness",
            ylabel = "λ",
            title = "Chromium (Cr)",
